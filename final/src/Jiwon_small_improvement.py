...
#load files
train = pd.read_csv('../input/train_fixed.csv', parse_dates=['timestamp'])
test = pd.read_csv('../input/test_fixed.csv', parse_dates=['timestamp'])
id_test = test.id
...
mult = 1.056 # Trying another magic number
...
train = pd.read_csv('../input/train_fixed.csv')
test = pd.read_csv('../input/test_fixed.csv')
id_test = test.id
...
df_train = pd.read_csv("../input/train_fixed.csv", parse_dates=['timestamp'])
df_test = pd.read_csv("../input/test_fixed.csv", parse_dates=['timestamp'])
